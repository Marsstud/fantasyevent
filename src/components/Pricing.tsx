        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="card-magical p-10 rounded-[3rem] border border-white/10 hover:animate-border-glow">
            ...
            <ul className="space-y-5 mb-12 text-white/50 text-sm font-medium">
              <li className="flex items-center gap-3"><span className="material-symbols-outlined text-primary text-lg">star</span> 1 герой / 15 минут</li>
              <li className="flex items-center gap-3"><span className="material-symbols-outlined text-primary text-lg">star</span> Музыкальный вынос</li>
              <li className="flex items-center gap-3"><span className="material-symbols-outlined text-primary text-lg">star</span> Поздравление и фото</li>
            </ul>
          ...
          <div className="card-magical p-10 rounded-[3rem] border border-white/10 hover:animate-border-glow">
            ...
            <ul className="space-y-5 mb-12 text-white/50 text-sm font-medium">
              <li className="flex items-center gap-3"><span className="material-symbols-outlined text-primary text-lg">flare</span> 2 героя / 1.5 часа</li>
              <li className="flex items-center gap-3"><span className="material-symbols-outlined text-primary text-lg">flare</span> Шоу мыльных пузырей</li>
              <li className="flex items-center gap-3"><span className="material-symbols-outlined text-primary text-lg">flare</span> Аквагрим для всех</li>
              <li className="flex items-center gap-3"><span className="material-symbols-outlined text-primary text-lg">flare</span> Профи-фотограф</li>
            </ul>
            <button className="w-full py-4 glass-magic text-white hover:text-primary rounded-2xl font-black transition-all border-white/20">Выбрать</button>
          </div>
          {/* VIP */}
